...
export default function KumaonFest2024Gallery() {
  const data = kumaonFestGalleries.kumaonFest2024
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-gray-900/95 backdrop-blur supports-[backdrop-filter]:bg-gray-900/90 border-gray-800">
        <div className="container flex h-16 items-center justify-between px-4">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/kumaon-fest/gallery/2024" className="text-sm font-medium text-yellow-400">
              2024
            </Link>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
              <div className="space-y-6">
                <div className="space-y-4">
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-gray-900">About the 2024 Edition</h2>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <p className="max-w-[600px] text-gray-600 md:text-xl">
                Experience the most innovative and spectacular Kumaon Fest yet
              </p>
            </div>
